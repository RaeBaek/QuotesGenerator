...
class ViewController: UIViewController {
    ...
    let quotes = [
        Quote(contents: "죽음을 두려워하는 나머지 삻을 시작도 못하는 사람이 많다.", name: "벤다이크"),
        Quote(contents: "나는 나 자신을 빼 놓고는 모두 안다.", name: "비용"),
        Quote(contents: "편견이란 실용성이 없는 의견이다.", name: "암브로스 빌"),
    ...
    @IBAction func tapQuoteGeneratorButton(_ sender: UIButton) {
        ...
        let qoute = quotes[random]
        self.quoteLabel.text = qoute.contents
        self.nameLabel.text = qoute.name
